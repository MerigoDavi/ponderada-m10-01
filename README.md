...
## Davi:
Após arrumar o erro pré-existente, adicionei a opção de outros dados em ```val dados```, e adicionei de forma proporcional, os casos de cada um dos dados, e seu devido range. Após a realização de diversas rolagens, foi possível afirmar que todos os dados estão funcionando devidamente
